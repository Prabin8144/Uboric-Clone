...
export const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="sec">
        <img
          src="https://www.uboric.com/wp-content/uploads/2020/12/kithchen-tools-768x602.jpg"
          alt=""
        />
        <img
          src="https://www.uboric.com/wp-content/uploads/2020/12/Air-Tight-Containers-768x602.jpg"
          alt=""
        />
        <img
      ...
      <div className="first">
        <img
          src="https://www.uboric.com/wp-content/uploads/elementor/thumbs/other-category-heading-pkx8tu1r8n97qduq2ja9rlt0l2lgx8yc1tsaz101ow.png"
          alt=""
        />
        <h1>
          OTHER <br /> CATEGORIE
      ...
      <div className="frth">
        ...
        />
        <img
          src="https://www.uboric.com/wp-content/uploads/2020/12/Braclate-400x601.jpg"
          alt=""
        />
        <img
      ...
      <div className="five">
        <img
          src="https://www.uboric.com/wp-content/uploads/elementor/thumbs/spices-heading-2-e1608267173425-pkx8te2i0gnc90hxnudm37u6his8ae6wbmp1tbnqmo.png"
          alt=""
        />
        <h1>SPICES</h1>
        <img
      ...
      <div className="five">
        <img
          src="https://www.uboric.com/wp-content/uploads/elementor/thumbs/shoes-icon-right-e1605175492472-pkxdahmpc96i32hqyh9qfkc7owqxivqr4zuwukso7k.png"
          alt=""
        />
        <h1>FOOT WEAR</h1>
        <img
          src="https://www.uboric.com/wp-content/uploads/elementor/thumbs/shoes-icon-left-e1605175515419-pkxdaq391ri2zk5gl2xdk07d1dl8g5oc65qa62g4nk.png"
          alt=""
        />
      </div>
      ...
      <div style={{ marginTop: "70px" }}>
        <h1>
          The Ultimate Domestic Online Shopping Experience <br /> Platform in
          India
        </h1>
        <br />
      </div>
